...
?>
    <div class="wrap wpcm-options">
      ...
      <div class="wpcm">
        ...
        <div class="wpcm-support">
          ...
          <h3>GitHub</h3>
          <p>Give a <a href="https://github.com/VickyAgravat/wp-codemirror-block" target="_blank">Star on Github</a> or make contribution on <a href="https://github.com/VickyAgravat/wp-codemirror-block/issues" target="_blank">Issues</a> to Support Continue Development.</p>
        </div>
      </div>
    </div>
  <?php
  ...
  public static function fields()
  {
    $fields = array(
      ...
      array(
        'label' => 'Enable Fixed Height Block?',
        'id' => 'maxHeight',
        'type' => 'radio',
        'options' => array(
          'no' => 'No',
